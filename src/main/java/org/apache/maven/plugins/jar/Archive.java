...
final class Archive {
    ...
    final class FileSet {
         ...
         */
        private FileSet(final Path directory, final String version) {
    ...
    public boolean canReuseJAR() {
        ...
        return tc.canReuseJAR(fileSets);
    }
     ...
     */
    FileSet newTargetRelease(Path directory, String version) {
